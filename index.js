...
search.addEventListener("click", () => {
    const APIKey = "8416ea2e2fb62466cceecf06ace72d97";
    const city = document.querySelector(".search-box input").value;

    if (city === "") return;

    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${APIKey}&units=metric&lang=es`)
        ...
        .then(json => {
            ...
            switch (json.weather[0].main) {
                ...
                case 'Haze':
                    ...
                    backgroundVideo.src = 'video/mist.mp4';
                    break;
                default:
                    image.src = '';
                    backgroundVideo.src = '';
